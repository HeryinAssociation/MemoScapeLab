...
CREATE TABLE IF NOT EXISTS projects (
  ...
  reference_panorama_image_url TEXT NOT NULL DEFAULT '',
  reference_panorama_thumbnail_url TEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS image_gen_tasks (
  ...
  generation_mode TEXT NOT NULL DEFAULT 'historical_only',
